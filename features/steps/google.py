...
def step_impl(context):
    wait = WebDriverWait(context.browser, timeout=10)
    wait.until(lambda d: context.browser.find_element(By.XPATH,
                                                      '//*[@id="rso"]/div[1]/div/div/div/div/div/div/div/div[1]/div/span/a')).is_enabled()
    result_name = context.browser.find_element(By.XPATH,
                                               '//*[@id="rso"]/div[1]/div/div/div/div/div/div/div/div[1]/div/span/a/h3').text
...
def step_impl(context):
    context.browser.find_element(By.XPATH,
                                 '//*[@id="rso"]/div[1]/div/div/div/div/div/div/div/div[1]/div/span/a').click()
